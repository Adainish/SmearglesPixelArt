...
6. Correct guesses award points (first correct = 10, then decreasing to a minimum of 1).
7. If nobody guesses correctly before the build finishes, the round ends with the answer revealed.
8. After the configured number of rounds, player totals are compared and the top scorer(s) win.
